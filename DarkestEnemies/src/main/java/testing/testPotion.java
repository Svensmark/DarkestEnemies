...
public class testPotion {
    ...
    public static void main(String[] args) throws ItemNotFoundException, CharacterNotFoundException {
        ...
        PotionFacade ifc = PotionFacade.getInventoryFacade(_emf);
        //databaseSetup(acF, ifc);

//        CharacterSetup(ifc, pfc);
    }

    private static void databaseSetup(AccountFacade acF, PotionFacade ifc) {
...
//      private static void CharacterSetup(PotionFacade ifc, PlayerFacade pfc) throws CharacterNotFoundException, ItemNotFoundException {
...
//    }
    private static void SetupPotions(PotionFacade ifc) {
